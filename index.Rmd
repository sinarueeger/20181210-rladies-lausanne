---
title: "Brief introduction to Drake"
...
- `readd(data)` display target.
- `loadd(data)` load target into R session.
...
- What if you have lots of folders, instead of a *flat* folder structure?
